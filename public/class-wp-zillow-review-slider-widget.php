...
class wpzillow_Widget extends WP_Widget {

  // Set up the widget name and description.
  public function __construct() {
    $widget_options = array( 'classname' => 'wpzillow_widget', 'description' => 'Widget for WP Zillow Review Slider Plugin. Allows you to display your reviews in your widget areas.' );
    parent::__construct( 'wpzillow_widget', 'WP Zillow Review Slider', $widget_options );
  }
  ...
  public function widget( $args, $instance ) {
	...
	if($templatedetails){
		...
		include plugin_dir_path( __FILE__ ) . 'partials/wp-zillow-review-slider-public-display-widget.php';
...
// Register the widget.
function wpzillow_register_widget() { 
  register_widget( 'wpzillow_Widget' );
}
add_action( 'widgets_init', 'wpzillow_register_widget' );
