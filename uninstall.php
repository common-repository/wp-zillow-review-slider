...
if ( ! defined( 'WP_UNINSTALL_PLUGIN' ) ) {
	exit;
		...
		// Leave no trail wp-zillow-review-slider_version widget_wpzillow_widget
		$option1 = 'wp-zillow-review-slider_version';
		$option2 = 'wpzillow_zillow_settings';
		$option3 = 'widget_wpzillow_widget';
		$option4 = 'wpzillow_options';
